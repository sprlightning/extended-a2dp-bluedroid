...
**  Type Definitions
*****************************************************************************/
// data type for the LHDCV5 Codec Information Element */
// NOTE: bits_per_sample is needed only for LHDCV5 encoder initialization.
// typedef struct {
//   uint32_t vendorId;
//   uint16_t codecId;    /* Codec ID for LHDCV5 */
//   uint8_t sampleRate;  /* Sampling Frequency */
//   uint8_t channelMode; /* STEREO/DUAL/MONO */
//   uint8_t qualityMode; /* Quality Mode */
...
//   uint8_t bitsPerSample;                                /* Bits Per Sample Type */
  btav_a2dp_codec_bits_per_sample_t bits_per_sample;    /* Bits Per Sample Type */
...
**
******************************************************************************/
tA2D_STATUS A2DP_CodecInfoMatchesCapabilityLhdcv5(
...
**
******************************************************************************/
tA2D_STATUS A2DP_BuildInfoLhdcv5(uint8_t media_type, const tA2DP_LHDCV5_CIE* p_ie, uint8_t* p_result);
