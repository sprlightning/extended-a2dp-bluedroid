...
export TONE_TEST ?= 0
ifeq ($(TONE_TEST),1)
KBUILD_CPPFLAGS += -D__TONE_TEST__
endif

export LICKEY ?= 1
ifeq ($(LICKEY),1)
KBUILD_CPPFLAGS += -D__LICKEY__
endif

export POWERON_UUID_READ ?= 1
ifeq ($(POWERON_UUID_READ),1)
KBUILD_CPPFLAGS += -D__POWERON_UUID_READ__
endif

export GAMMODE ?= 1
ifeq ($(GAMMODE),1)
KBUILD_CPPFLAGS += -D__GAMMODE__
endif
...
export BOX_DET_FJH ?= 1
ifeq ($(BOX_DET_FJH),1)
KBUILD_CPPFLAGS += -D__BOX_DET_FJH__
endif

export JS1228_SENSOR ?= 0
ifeq ($(JS1228_SENSOR),1)
KBUILD_CPPFLAGS += -D__JS1228_SENSOR__
endif

export FJH_APPS ?= 1
ifeq ($(FJH_APPS), 1)
KBUILD_CPPFLAGS += -D__FJH_APPS__
endif

export FJH_SPP_CONNECT_DIS_SNIFF ?= 1
ifeq ($(FJH_SPP_CONNECT_DIS_SNIFF), 1)
KBUILD_CPPFLAGS += -D__FJH_SPP_CONNECT_DIS_SNIFF__
endif

export FJH_LED_2500UI ?= 1
ifeq ($(FJH_LED_2500UI), 1)
KBUILD_CPPFLAGS += -D__FJH_LED_2500UI__
endif

export ANC_SWITCH_DELAY_FJH ?= 0
ifeq ($(ANC_SWITCH_DELAY_FJH), 1)
KBUILD_CPPFLAGS += -D__ANC_SWITCH_DELAY_FJH__
endif

export FJH_BOX_MODULE ?= 1
ifeq ($(FJH_BOX_MODULE), 1)
KBUILD_CPPFLAGS += -D__FJH_BOX_MODULE__
endif

export FJH_SIRI_BUG ?= 1
ifeq ($(FJH_SIRI_BUG), 1)
KBUILD_CPPFLAGS += -D__FJH_SIRI_BUG__
endif

export FJH_TWS_AUDIO_CHANNEL_BUG ?= 1
ifeq ($(FJH_TWS_AUDIO_CHANNEL_BUG), 1)
KBUILD_CPPFLAGS += -D__FJH_TWS_AUDIO_CHANNEL_BUG__ 
endif

export FJH_BATTERY_MANAGEMENT ?= 1
ifeq ($(FJH_BATTERY_MANAGEMENT), 1)
KBUILD_CPPFLAGS += -D__FJH_BATTERY_MANAGEMENT__ 
endif
...
export FJH_FATCH_OUT_ERROR ?= 1
ifeq ($(FJH_FATCH_OUT_ERROR), 1)
KBUILD_CPPFLAGS += -D__FJH_FATCH_OUT_ERROR__ 
endif

export FJH_SLAVER_BUG ?= 1
ifeq ($(FJH_SLAVER_BUG), 1)
KBUILD_CPPFLAGS += -D__FJH_SLAVER_BUG__
endif

export SPP_MIC_TEST ?= 1
ifeq ($(SPP_MIC_TEST), 1)
KBUILD_CPPFLAGS += -D__SPP_MIC_TEST__
endif

export FJH_PATCH_003 ?= 1
ifeq ($(FJH_PATCH_003), 1)
KBUILD_CPPFLAGS += -D__FJH_PATCH_003__
endif

export FJH_PATCH_004 ?= 1
ifeq ($(FJH_PATCH_004), 1)
KBUILD_CPPFLAGS += -D__FJH_PATCH_004__
endif


export POWERONAUTOOPENANC ?= 0
ifeq ($(POWERONAUTOOPENANC), 1)
KBUILD_CPPFLAGS += -D__POWERONAUTOOPENANC__
endif

export HFPAUTOTOPHONE ?= 0
ifeq ($(HFPAUTOTOPHONE), 1)
KBUILD_CPPFLAGS += -D__HFPAUTOTOPHONE__
endif

export TWSPAIRLISTNV ?= 1
ifeq ($(TWSPAIRLISTNV),1)
KBUILD_CPPFLAGS += -D__TWSPAIRLISTNV__
endif

export BES_KEY_BUG ?= 1
ifeq ($(BES_KEY_BUG),1)
KBUILD_CPPFLAGS += -D__BES_KEY_BUG__
endif

export POWERON_ENTERPAIRING ?= 0
ifeq ($(POWERON_ENTERPAIRING),1)
KBUILD_CPPFLAGS += -D__POWERON_ENTERPAIRING__
endif

export CLOSEBOX_PATCH ?= 1
ifeq ($(CLOSEBOX_PATCH),1)
KBUILD_CPPFLAGS += -D__CLOSEBOX_PATCH__
endif

export A2DP_SPP_PATCH ?= 1
ifeq ($(A2DP_SPP_PATCH),1)
KBUILD_CPPFLAGS += -D__A2DP_SPP_PATCH__
endif

#*************call 208M enable************************
export PHOEN_CARCH ?= 0
ifeq ($(PHOEN_CARCH),1)
KBUILD_CPPFLAGS += -D__PHOEN_CARCH__
endif

export CHARING_BQB ?= 0
ifeq ($(CHARING_BQB),1)
KBUILD_CPPFLAGS += -D__CHARING_BQB__
endif

export CLICKUPLONGEVENT ?= 0
ifeq ($(CLICKUPLONGEVENT),1)
KBUILD_CPPFLAGS += -D__CLICKUPLONGEVENT__
endif

export BLEAPPKEY ?= 1
ifeq ($(BLEAPPKEY),1)
KBUILD_CPPFLAGS += -D__BLEAPPKEY__
endif

export BLE_S80 ?= 0
ifeq ($(BLE_S80),1)
KBUILD_CPPFLAGS += -D__BLE_S80__
endif



export INOUT_BOX_CLOSE ?= 0
ifeq ($(INOUT_BOX_CLOSE),1)
KBUILD_CPPFLAGS += -D__INOUT_BOX_CLOSE__
endif

export NTC_PATCH ?= 1
ifeq ($(NTC_PATCH),1)
KBUILD_CPPFLAGS += -D__NTC_PATCH__
endif

export CHRING_OUT_DUT_PATCH ?= 1
ifeq ($(CHRING_OUT_DUT_PATCH),1)
KBUILD_CPPFLAGS += -D__CHRING_OUT_DUT_PATCH__
endif

export CLOSEBOX_RESET_BATTERY_LVE ?= 1
ifeq ($(CLOSEBOX_RESET_BATTERY_LVE),1)
KBUILD_CPPFLAGS += -D__CLOSEBOX_RESET_BATTERY_LVE__
endif
...
export CHARING_PATCH ?= 1
ifeq ($(CHARING_PATCH),1)
KBUILD_CPPFLAGS += -D__CHARING_PATCH__
endif

export INOUTBOX_PATCH ?= 1
ifeq ($(INOUTBOX_PATCH),1)
KBUILD_CPPFLAGS += -D__INOUTBOX_PATCH__
endif

export CLOSEBOX_BLEDATA_SET ?= 1
ifeq ($(CLOSEBOX_BLEDATA_SET),1)
KBUILD_CPPFLAGS += -D__CLOSEBOX_BLEDATA_SET__
endif

export A2DP_PLAY_START_PATCH ?= 1
ifeq ($(A2DP_PLAY_START_PATCH),1)
KBUILD_CPPFLAGS += -D__A2DP_PLAY_START_PATCH__
endif

export HFP_VOLUME_PATCH ?= 1
ifeq ($(HFP_VOLUME_PATCH),1)
KBUILD_CPPFLAGS += -D__HFP_VOLUME_PATCH__
endif

export BOX3_PATCH ?= 1
ifeq ($(BOX3_PATCH),1)
KBUILD_CPPFLAGS += -D__BOX3_PATCH__
endif

export BLE_ADV_PATCH ?= 1
ifeq ($(BLE_ADV_PATCH),1)
KBUILD_CPPFLAGS += -D__BLE_ADV_PATCH__
endif

export INOUTBOX_STATUS_APP_PATCH ?= 1
ifeq ($(INOUTBOX_STATUS_APP_PATCH),1)
KBUILD_CPPFLAGS += -D__INOUTBOX_STATUS_APP_PATCH__
endif

export INBOX_STATUS_INT_PATCH ?= 1
ifeq ($(INBOX_STATUS_INT_PATCH),1)
KBUILD_CPPFLAGS += -D__INBOX_STATUS_INT_PATCH__
endif

export BATTERY_APP_BUG ?= 0
ifeq ($(BATTERY_APP_BUG),1)
KBUILD_CPPFLAGS += -D__BATTERY_APP_BUG__
endif

export SCO_TWS_SWITCH_PATCH ?= 1
ifeq ($(SCO_TWS_SWITCH_PATCH),1)
KBUILD_CPPFLAGS += -D__SCO_TWS_SWITCH_PATCH__
endif


export CLOSEBOX_TWS_SWITCH_PATCH ?= 1
ifeq ($(CLOSEBOX_TWS_SWITCH_PATCH),1)
KBUILD_CPPFLAGS += -D__CLOSEBOX_TWS_SWITCH_PATCH__
endif


export CLOSEBOX_TWS_SWITCH_PATCH22 ?= 1
ifeq ($(CLOSEBOX_TWS_SWITCH_PATCH22),1)
KBUILD_CPPFLAGS += -D__CLOSEBOX_TWS_SWITCH_PATCH22__
endif

export CLOSEBOX_TWS_SWITCH_PATCH23 ?= 1
ifeq ($(CLOSEBOX_TWS_SWITCH_PATCH23),1)
KBUILD_CPPFLAGS += -D__CLOSEBOX_TWS_SWITCH_PATCH23__
endif

export BT_NAME_GUHUA ?= 1
ifeq ($(BT_NAME_GUHUA),1)
KBUILD_CPPFLAGS += -D__BT_NAME_GUHUA__
endif

export LINKLOSS_NO_CONNECT_TONE ?= 1
ifeq ($(LINKLOSS_NO_CONNECT_TONE),1)
KBUILD_CPPFLAGS += -D__LINKLOSS_NO_CONNECT_TONE__
endif


export RELEASE_A2DP_VOLUME ?= 1
ifeq ($(RELEASE_A2DP_VOLUME),1)
KBUILD_CPPFLAGS += -D__RELEASE_A2DP_VOLUME__
endif


export POWERON_RECONNECT_PAIIRNG ?= 1
ifeq ($(POWERON_RECONNECT_PAIIRNG),1)
KBUILD_CPPFLAGS += -D__POWERON_RECONNECT_PAIIRNG__
endif


export KEY_TONE ?= 1
ifeq ($(KEY_TONE),1)
KBUILD_CPPFLAGS += -D__KEY_TONE__
endif



#export SNDP_TX_3MIC_ENABLE ?= 1
...
BLE_APP_DATAPATH_SERVER_ENABLED ?= 1
...
ifeq ($(ELEVOC),1)
export SCO_TRACE_CP_ACCEL := 0
export ELEVOC_CP_ACCEL ?= 1
export ELEVOC_TX_ENABLE ?= 1
export ELEVOC_TX_BYPASS_ENABLE ?= 0
export ELEVOC_TX_DUMP_ENABLE ?= 0
...
KBUILD_CPPFLAGS += -DELEVOC
ifeq ($(ELEVOC_CP_ACCEL), 1)
KBUILD_CPPFLAGS += -DELEVOC_CP_ACCEL
endif

ifeq ($(ELEVOC_TX_ENABLE), 1)
KBUILD_CPPFLAGS += -DELEVOC_TX_ENABLE
endif

ifeq ($(ELEVOC_TX_BYPASS_ENABLE), 1)
KBUILD_CPPFLAGS += -DELEVOC_TX_BYPASS_ENABLE
endif

ifeq ($(ELEVOC_RX_ENABLE), 1)
KBUILD_CPPFLAGS += -DELEVOC_RX_ENABLE
endif

ifeq ($(ELEVOC_TX_DUMP_ENABLE), 1)
KBUILD_CPPFLAGS += -DELEVOC_TX_DUMP_ENABLE
endif

ifeq ($(ELEVOC_RX_DUMP_ENABLE), 1)
KBUILD_CPPFLAGS += -DELEVOC_RX_DUMP_ENABLE
endif
#export RAMCP_SIZE  := 0x28000
export RAMCP_SIZE  := 0x27000
export RAMCPX_SIZE := 0x12000
else
export SCO_TRACE_CP_ACCEL := 0
export SCO_CP_ACCEL := 0
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM := 2
...
export FAST_XRAM_SECTION_SIZE ?= 0x8400

ifeq ($(SPEECH_TX_DTLN),1)
core-y += thirdparty/tflite/
endif

export FAST_XRAM_SECTION_SIZE ?= 0xb000
