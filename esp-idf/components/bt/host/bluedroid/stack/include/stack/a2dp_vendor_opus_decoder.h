...
/******************************************************************************
**
** Function         a2dp_opus_decoder_init
**
** Description      Initialize the A2DP Opus decoder
**
...
/******************************************************************************
**
** Function         a2dp_opus_decoder_cleanup
**
** Description      Cleanup the A2DP Opus decoder.
**
******************************************************************************/
...
/******************************************************************************
**
** Function         a2dp_opus_decoder_configure
**
** Description      Configure the Opus decoder.
**
...
/******************************************************************************
**
** Function         a2dp_opus_decoder_decode_packet_header
**
** Description      Decode the Opus packet header.
**
** Returns          
**
******************************************************************************/
ssize_t a2dp_opus_decoder_decode_packet_header(BT_HDR* p_data);

/******************************************************************************
**
** Function         a2dp_opus_decoder_decode_packet
**
** Description      Decodes |p_buf|. Calls |decode_callback| passed into |a2dp_opus_decoder_init|
